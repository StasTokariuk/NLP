...
def main():
    ...
    if len(source_texts) > 1:
        ...
        matrix = tfidf.fit_transform(source_texts.values)
    ...
    negative_triggers = [
        'вбив', 'вбит', 'загинул', 'загинув', 'смерт', 'трагічн',
        'жертв', 'поранен', 'постраждал', 'атак', 'обстріл', 'катастроф',
        'дтп', 'знищ', 'вибух'
    ]
    ...
    if sim_df is not None:
        ...
        axes[0].set_title('Подібність контенту (TF-IDF)')
    ...
    plt.tight_layout()
    plt.savefig('lab5_results.png', dpi=150)
    print("Звіт збережено у 'lab5_results.png'")
